...
main() {
  ...
  RpcServer server = new RpcServer(new HttpServerConnector('localhost', 8080));
  ...
  RpcClient client = new RpcClient(new HttpClientConnector(Uri.parse("http://localhost:8080/")));
